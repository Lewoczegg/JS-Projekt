...
const Home = () => {
  ...
  const handleFriendRequset = async (id) => {
    try {
  ...
  const acceptFriendRequset = async (id, status) => {
    try {
      const res = await apiRequest({
                  ...
                  <div key={_id} className="flex items-center justify-between">
                    ...
                    <div className="flex gap-1">
                      <CustomButton
                        ...
                        onClick={() => acceptFriendRequset(_id, "Accepted")}
                      />
                      <CustomButton
                        title="Deny"
                        containerStyles="border border-[#666] text-xs text-ascent-1 px-1.5 py-1 rounded-full"
                        onClick={() => acceptFriendRequset(_id, "Denied")}
                      />
                    </div>
                  </div>
                ))}
                  ...
                  >
                    ...
                    <div className="flex gap-1">
                      <button
                        ...
                        onClick={() => handleFriendRequset(friend?._id)}
                      >
